...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('suggestions', '0012_remove_questionarymodel_diet_meal_quantity_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='questionarymodel',
            name='on_a_diet',
            field=models.CharField(choices=[('YES', 'Yes'), ('NO', 'No')], default=None, max_length=32),
        ),
        migrations.AddField(
            model_name='questionarymodel',
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(choices=[('YES', 'Yes'), ('NO', 'No')], default=None, max_length=32),
        ),
    ]
